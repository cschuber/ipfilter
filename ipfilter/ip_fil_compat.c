...
static void
frentry_16_to_current(old, current)
	frentry_4_1_16_t *old;
	void *current;
{
...
static void
frentry_0_to_current(old, current)
	frentry_4_1_0_t *old;
	void *current;
{
	frentry_t *fr = (frentry_t *)current;
...
static void
friostat_0_to_current(old, current)
	friostat_4_1_0_t *old;
	void *current;
{
...
static void
ipnat_0_to_current(old, current)
	ipnat_4_1_0_t *old;
	void *current;
{
...
static void
frauth_29_to_current(old, current)
	frauth_4_1_29_t *old;
	void *current;
{
...
static void
frauth_24_to_current(old, current)
	frauth_4_1_24_t *old;
	void *current;
{
	frauth_t *fra = (frauth_t *)current;
...
static void
frauth_23_to_current(old, current)
	frauth_4_1_23_t *old;
	void *current;
{
	frauth_t *fra = (frauth_t *)current;
...
static void
frauth_11_to_current(old, current)
	frauth_4_1_11_t *old;
	void *current;
{
	frauth_t *fra = (frauth_t *)current;
...
static void
fr_info_24_to_current(old, current)
...
static void
fr_info_23_to_current(old, current)
...
static void
fr_info_11_to_current(old, current)
...
static void
nat_save_16_to_current(old, current)
...
static void
nat_save_14_to_current(old, current)
...
static void
nat_save_3_to_current(old, current)
...
static void
ipstate_save_current_to_16(current, old)
	void *current;
	ipstate_save_4_1_16_t *old;
{
...
static void
ipstate_save_current_to_0(current, old)
	void *current;
	ipstate_save_4_1_0_t *old;
{
	ipstate_save_t *ips = (ipstate_save_t *)current;
...
static void
friostat_current_to_0(current, old, rev)
	void *current;
	friostat_4_1_0_t *old;
	int rev;
{
...
static void
frentry_current_to_16(current, old)
	void *current;
	frentry_4_1_16_t *old;
{
	frentry_t *fr = (frentry_t *)current;
...
static void
frentry_current_to_0(current, old)
	void *current;
	frentry_4_1_0_t *old;
{
	frentry_t *fr = (frentry_t *)current;
...
static void
fr_info_current_to_24(current, old)
	void *current;
	fr_info_4_1_24_t *old;
{
	fr_info_t *fin = (fr_info_t *)current;
...
static void
fr_info_current_to_23(current, old)
	void *current;
	fr_info_4_1_23_t *old;
{
	fr_info_t *fin = (fr_info_t *)current;
...
static void
fr_info_current_to_11(current, old)
	void *current;
	fr_info_4_1_11_t *old;
{
	fr_info_t *fin = (fr_info_t *)current;
...
static void
frauth_current_to_29(current, old)
	void *current;
	frauth_4_1_29_t *old;
{
	frauth_t *fra = (frauth_t *)current;
...
static void
frauth_current_to_24(current, old)
	void *current;
	frauth_4_1_24_t *old;
{
	frauth_t *fra = (frauth_t *)current;
...
static void
frauth_current_to_23(current, old)
	void *current;
	frauth_4_1_23_t *old;
{
	frauth_t *fra = (frauth_t *)current;
...
static void
frauth_current_to_11(current, old)
	void *current;
	frauth_4_1_11_t *old;
{
	frauth_t *fra = (frauth_t *)current;
...
static void
ipnat_current_to_0(current, old)
	void *current;
	ipnat_4_1_0_t *old;
{
	ipnat_t *np = (ipnat_t *)current;
...
static void
ipstate_current_to_0(current, old)
	void *current;
	ipstate_4_1_0_t *old;
{
...
static void
nat_save_current_to_16(current, old)
	void *current;
	nat_save_4_1_16_t *old;
{
	nat_save_t *nats = (nat_save_t *)current;
...
static void
nat_save_current_to_14(current, old)
	void *current;
	nat_save_4_1_14_t *old;
{
	nat_save_t *nats = (nat_save_t *)current;
...
static void
nat_save_current_to_3(current, old)
	void *current;
	nat_save_4_1_3_t *old;
{
	nat_save_t *nats = (nat_save_t *)current;
