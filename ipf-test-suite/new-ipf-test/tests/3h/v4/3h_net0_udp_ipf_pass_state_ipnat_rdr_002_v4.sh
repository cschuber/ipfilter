...
gen_ipnat_conf() {
	cat <<__EOF__
rdr ${SUT_NET0_IFP_NAME} ${NET0_FAKE_ADDR_V4} port 1000:2000 -> ${RECEIVER_NET1_ADDR_V4} port 5050 udp
__EOF__
	return 0;
}
...
do_test() {
	start_udp_server ${RECEIVER_CTL_HOSTNAME} ${RECEIVER_NET1_ADDR_V4} 5550
	sleep 3
