...
pass in on ${SUT_NET0_IFP_NAME} inet6 proto ipv6-icmp from any to any with frag
pass out on ${SUT_NET0_IFP_NAME} inet6 proto ipv6-icmp from any to any icmp-type echorep
pass out on ${SUT_NET0_IFP_NAME} inet6 proto ipv6-icmp from any to any with frag
__EOF__
	return 0;
}
