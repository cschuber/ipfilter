...
gen_ipf_conf() {
	...
	generate_test_hdr
	cat << __EOF__
pass in on ${SUT_NET0_IFP_NAME} proto tcp from pool/net0hosts to pool/net0hosts
pass out on ${SUT_NET0_IFP_NAME} proto tcp from pool/net0hosts to pool/net0hosts
__EOF__
	return 0;
}
