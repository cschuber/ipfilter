...
gen_ipf_conf() {
	...
	generate_test_hdr
	cat << __EOF__
pass in on ${SUT_NET0_IFP_NAME} proto udp from hash/net0hosts to hash/net0hosts
pass out on ${SUT_NET0_IFP_NAME} proto udp from hash/net0hosts to hash/net0hosts
__EOF__
	return 0;
}
