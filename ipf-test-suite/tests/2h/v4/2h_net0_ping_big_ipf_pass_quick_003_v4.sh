...
gen_ipf_conf() {
	generate_test_hdr
	cat << __EOF__
pass in quick on ${SUT_NET0_IFP_NAME} proto icmp from any to ${SUT_NET0_ADDR_V4}/${NET0_NETMASK_V4}
pass out quick on ${SUT_NET0_IFP_NAME} proto icmp from ${SUT_NET0_ADDR_V4}/${NET0_NETMASK_V4} to any
__EOF__
