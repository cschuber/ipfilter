...
do_test() {
	start_tcp_server ${SENDER_CTL_HOSTNAME} ${RECEIVER_NET0_ADDR_V4} 5051 A
	start_tcp_server ${SENDER_CTL_HOSTNAME} ${RECEIVER_NET0_ADDR_V4_A1} 5052 B
	start_tcp_server ${SENDER_CTL_HOSTNAME} ${RECEIVER_NET0_ADDR_V4_A2} 5053 C
	...
	${BIN_IPFSTAT} -Rslm "tcp.port = 5053;" > ${IPF_TMP_DIR}/ipfstat.out
