...
gen_ipnat_conf() {
	cat <<__EOF__
rdr ${SUT_NET0_IFP_NAME} ${NET1_FAKE_ADDR_V4} port 1050 -> ${RECEIVER_NET1_ADDR_V4} port = 5050 tcp round-robin
rdr ${SUT_NET0_IFP_NAME} ${NET1_FAKE_ADDR_V4} port 1050 -> ${RECEIVER_NET1_ADDR_V4} port = 5060 tcp round-robin
rdr ${SUT_NET0_IFP_NAME} ${NET1_FAKE_ADDR_V4} port 1050 -> ${RECEIVER_NET1_ADDR_V4} port = 5070 tcp round-robin
__EOF__
	return 0;
}
...
do_test() {
	...
	start_tcp_server ${RECEIVER_CTL_HOSTNAME} ${RECEIVER_NET1_ADDR_V4} 5070 C
	sleep 3
