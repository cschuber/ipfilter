...
pass out on ${SUT_NET0_IFP_NAME} proto tcp from ${RECEIVER_NET1_ADDR_V4} port < 5055 to ${SENDER_NET0_ADDR_V4}
pass out on ${SUT_NET1_IFP_NAME} proto tcp from any to ${RECEIVER_NET1_ADDR_V4} port < 5055
pass in on ${SUT_NET1_IFP_NAME} proto tcp from ${RECEIVER_NET1_ADDR_V4} port < 5055 to ${SENDER_NET0_ADDR_V4}
__EOF__
	return 0;
}
...
do_test() {
	...
	sleep 1
	tcp_test ${SENDER_CTL_HOSTNAME} ${RECEIVER_NET1_ADDR_V4} 5054 pass
	ret=$?
